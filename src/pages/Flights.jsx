      ...
      <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white p-4 rounded-t-xl">
            <div className="flex justify-between items-center mb-2">
              <h3 className="font-bold font-header text-lg">
                ✈️ {t('Group 1 – Penang → Tokyo / Osaka → Penang', '第一组 – 槟城 → 东京 / 大阪 → 槟城')}
              </h3>
            ...
            <div className="text-xs bg-white/20 px-3 py-1 rounded inline-block mt-1">
              {t('Passengers (4):', '乘客 (4人):')} <span className="font-semibold">Cheng Wai Soon, Siew Pheng See, Yi Joe See, Siew Kim See</span>
            </div>
          </div>
            ...
            <div className="border-l-4 border-purple-500 pl-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="bg-green-50 border border-green-200 p-2 rounded text-xs">
                  <span className="font-semibold text-green-700">📍 {t('Arrive:', '抵达:')} </span>
                  <span className="text-green-800">Tokyo ({t('18 Mar 2026, night', '2026年3月18日晚')})</span>
                </div>
              </div>
            </div>
            {/* Return */}
            <div className="border-l-4 border-orange-500 pl-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="bg-blue-50 border border-blue-200 p-2 rounded text-xs space-y-1">
                  <div>
                    <span className="font-semibold text-blue-700">📍 {t('Depart Japan:', '离开日本:')} </span>
                    <span className="text-blue-800">Osaka</span>
                  </div>
                  <div>
                    <span className="font-semibold text-blue-700">📍 {t('Arrive Home:', '抵达家乡:')} </span>
                    <span className="text-blue-800">Penang ({t('28 Mar 2026, night', '2026年3月28日晚')})</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="glass-card rounded-2xl p-1 shadow-sm border-2 border-teal-200 hover:shadow-lg transition-shadow duration-300 animate-fade-in" style={{ animationDelay: '0.1s' }}>
          <div className="bg-gradient-to-r from-teal-600 to-teal-700 text-white p-4 rounded-t-xl">
            <div className="flex justify-between items-center mb-2">
              <h3 className="font-bold font-header text-lg">
                ✈️ {t('Group 2 – Singapore → Tokyo / Osaka → Singapore', '第二组 – 新加坡 → 东京 / 大阪 → 新加坡')}
              </h3>
              <span className="text-xs bg-white/20 px-2 py-1 rounded font-bold">CX</span>
            </div>
            <div className="text-xs bg-white/20 px-3 py-1 rounded inline-block mt-1">
              {t('Passenger (1):', '乘客 (1人):')} <span className="font-semibold">Ang Shin Nee</span>
            </div>
          </div>
          <div className="p-5 space-y-4">
            {/* Outbound */}
            ...
            <div className="border-l-4 border-orange-500 pl-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="bg-blue-50 border border-blue-200 p-2 rounded text-xs space-y-1">
                  ...
                  <div>
                    <span className="font-semibold text-blue-700">📍 {t('Arrive Home:', '抵达家乡:')} </span>
                    <span className="text-blue-800">Singapore ({t('28 Mar 2026, night', '2026年3月28日晚')})</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="glass-card rounded-2xl p-1 shadow-sm border-2 border-amber-200 hover:shadow-lg transition-shadow duration-300 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <div className="bg-gradient-to-r from-amber-600 to-amber-700 text-white p-4 rounded-t-xl">
            <div className="flex justify-between items-center mb-2">
              <h3 className="font-bold font-header text-lg">
                ✈️ {t('Group 3 – Penang → Osaka / Osaka → Penang', '第三组 – 槟城 → 大阪 / 大阪 → 槟城')}
              </h3>
              <span className="text-xs bg-white/20 px-2 py-1 rounded font-bold">CX</span>
            </div>
            <div className="text-xs bg-white/20 px-3 py-1 rounded inline-block mt-1">
          ...
          <div className="p-5 space-y-4">
            ...
            <div className="border-l-4 border-amber-500 pl-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="bg-green-50 border border-green-200 p-2 rounded text-xs">
                  <span className="font-semibold text-green-700">📍 {t('Arrive:', '抵达:')} </span>
                  <span className="text-green-800">Osaka ({t('21 Mar 2026, evening', '2026年3月21日晚')})</span>
                </div>
              </div>
            </div>
            {/* Return */}
              ...
              <div className="space-y-2 text-sm text-slate-700">
                <div className="bg-white/80 p-3 rounded-lg border border-indigo-200">
                  <div className="font-semibold text-indigo-700 mb-1">
                    {t('Earliest arrival in Japan:', '最早抵达日本:')}
                  </div>
                  <div className="text-slate-600">
                    {t('Group 1 & 2 → 18 Mar 2026 (Tokyo)', '第一组 & 第二组 → 2026年3月18日 (东京)')}
                  </div>
                </div>
                <div className="bg-white/80 p-3 rounded-lg border border-indigo-200">
                  <div className="font-semibold text-indigo-700 mb-1">
                    {t('Latest arrival in Japan:', '最晚抵达日本:')}
                  </div>
                  <div className="text-slate-600">
                    {t('Group 3 → 21 Mar 2026 (Osaka)', '第三组 → 2026年3月21日 (大阪)')}
                  </div>
                </div>
                <div className="bg-white/80 p-3 rounded-lg border border-indigo-200">
                  <div className="font-semibold text-indigo-700 mb-1">
                    {t('All groups depart Japan:', '所有组离开日本:')}
                  </div>
                  <div className="text-slate-600">
                    {t('28 Mar 2026 from Osaka', '2026年3月28日 从大阪')}
                  </div>
                </div>
              </div>
            </div>
