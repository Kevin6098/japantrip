  ...
  const quickLinks = [
    {
      to: '/split-expenses',
      icon: 'fa-calculator',
      title: t('Budget Splitter', '费用分摊器'),
      badge: t('NEW', '新'),
      description: t('Track & split expenses with your group', '与团队追踪和分摊费用'),
    ...
    },
    {
      ...
      icon: 'fa-train',
      title: t('Transportation', '交通'),
      description: t('Train, bus fares & walking times', '电车、巴士费用与步行时间'),
      bgColor: 'bg-blue-100',
    ...
    },
    {
      ...
      title: t('Checklist', '清单'),
      description: t('Quick checklist for the trip', '旅行快速检查清单'),
