...
const QuickLinkCard = ({ to, icon, title, description, bgColor = 'bg-purple-100', iconColor = 'text-purple-500' }) => {
  return (
    <Link
      to={to}
    ...
    >
      ...
      <h3 className="font-header text-xl font-bold text-slate-800 mb-2">
        {title}
      </h3>
